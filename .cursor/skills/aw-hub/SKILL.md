...
1. **[AW_品牌共通基石.md](../../../AW_品牌共通基石.md)** — **全技能先读**：品牌态度、产品理解、调性禁区。  
2. **[AW_品牌文案参考规则.md](../../../AW_品牌文案参考规则.md)** — 第四章起执行层（方法论、类型 A～F、海报、话术、创始人、dbs 协同等）；**aw-topic-brief** 与文案强相关；其它子技能见各自 `SKILL.md`。
